...
/**
 * Utility service responsible for decoding and parsing the Paseto token.
 */
@Slf4j
@Component
public class TokenProvider {
    ...
    public String generateToken(Authentication authentication) {
        ...
        return Pasetos.V2.LOCAL.builder()
                ...
                .setIssuedAt(now)
                .setExpiration(now.plus(12, ChronoUnit.HOURS))
                .setSubject(principal.getUsername())
                .setKeyId(UUID.randomUUID().toString())
                .setAudience("bookstore-user")
                .setIssuer("bookstore-developer")
    ...
    public Paseto parseToken(String token) {
        PasetoParser parser = Pasetos.parserBuilder()
                ...
                .requireAudience("bookstore-user")
                .requireIssuer("bookstore-developer")
                .build();
